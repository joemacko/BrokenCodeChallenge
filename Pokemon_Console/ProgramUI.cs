    ...
    public class ProgramUI
    {
        ...
        private void AddPokemonToTeam()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    Pokemon newPokemon = new Pokemon(position, species, name, level, typeOne, typeTwo, moveOne, moveTwo, moveThree, moveFour);
        ...
        private void UpdateAPokemonMenu()
        {
            ...
            else
            {
                Console.Clear();
                Console.WriteLine("My Team:");
                for (int i = 0; i < pokemonTeam.TeamPosition; i++)
                {
                    Console.WriteLine($"\n{i + 1}" +
        ...
        {
            Pokemon pokemon = _repo.GetPokemonByTeamPosition(pokemon.TeamPosition);
            Console.Clear();
